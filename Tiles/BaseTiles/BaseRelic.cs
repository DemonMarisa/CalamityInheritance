...
namespace CalamityInheritance.Tiles.BaseTiles
{
    public abstract class CIBaseRelic : ModTile
    {
        ...
        public override string Texture => "CalamityInheritance/Tiles/BaseTiles/RelicPedestalAlt";
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(131, 139, 131), Language.GetText("MapObject.Relic"));
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 drawPos = worldPos + offScreen - Main.screenPosition + new Vector2(0f, -45f) + new Vector2(0f, offset * 4f);
