...
{
    public class MusicBoxVerBehavior
    {
        ...
        public static bool MusicBoxVerOpen = false;
        public static void Update(Rectangle mouseRectangle)
        {
            ...
            #region 判定悬停
            MusicChoiceUI.FastButton(FadeTime, FadeTimeMax, ref Scale, ref Pos,ref IsHovering, ref SecondFadeTime, ref SecondFadeTimeMax, ref wasMouseDown, "CalTitleMusicBoxVer", ref MusicBoxVerOpen);
            #endregion
        }
        ...
        public static void UIDraw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(MusicChoiceUI.MusicBoxTextures, Pos, null, Color.White, 0f, MusicChoiceUI.MusicBoxTextures.Size() / 2, Scale, SpriteEffects.None, 0f);
            if (IsHovering && FadeTime == FadeTimeMax)
            {
                ...
                string text = Language.GetTextValue("Mods.CalamityInheritance.UI.CalTitleMusicBoxVerHover");
                if (MusicBoxVerOpen)
                    text = Language.GetTextValue("Mods.CalamityInheritance.UI.CalTitleMusicBoxVerHoverOff");
