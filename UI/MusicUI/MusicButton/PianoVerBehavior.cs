...
namespace CalamityInheritance.UI.MusicUI.MusicButton
{
    public class PianoVerBehavior
    {
        ...
        public static bool PianoVerOpen = false;
        public static void Update(Rectangle mouseRectangle)
        {
            ...
            #region 判定悬停
            MusicChoiceUI.FastButton(FadeTime, FadeTimeMax, ref Scale, ref Pos,ref IsHovering, ref SecondFadeTime, ref SecondFadeTimeMax, ref wasMouseDown, "CalTitlePianoVer", ref PianoVerOpen);
            #endregion
        }
        ...
        public static void UIDraw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(MusicChoiceUI.PianoTextures, Pos, null, Color.White, 0f, MusicChoiceUI.PianoTextures.Size() / 2, Scale, SpriteEffects.None, 0f);
            if (IsHovering && FadeTime == FadeTimeMax)
            {
                ...
                string text = Language.GetTextValue("Mods.CalamityInheritance.UI.CalTitlePianoVerHover");
                if (PianoVerOpen)
                    text = Language.GetTextValue("Mods.CalamityInheritance.UI.CalTitlePianoVerHoverOff");
