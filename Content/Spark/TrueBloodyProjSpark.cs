...
namespace CalamityInheritance.Content.Spark
{
    public static class TrueBloodyProjSpark
    {
        ...
        public static void GeneratePrettySparkles(Vector2 position, float num, float num2, float scaleModifier = 1f)
        {
            for (float num3 = 0f; num3 < 3f; num3 += 2f)
            {
                ...
                prettySparkleParticle.ColorTint = new Color(1f, 1f, 0.5f, 0.8f);
            ...
            for (float num4 = 0f; num4 < 3f; num4 += 2f)
            {
                ...
                prettySparkleParticle2.ColorTint = new Color(1f, 1f, 0f, 0.9f);
