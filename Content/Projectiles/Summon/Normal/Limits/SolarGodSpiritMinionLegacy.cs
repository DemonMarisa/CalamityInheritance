...
{
    public class SolarGodSpiritMinionLegacy : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            player.AddBuff(BuffType<SolarGodSpiritBuff>(), 2);
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (foundTarget)
                {
                    ...
                    velocity.Normalize();
                    velocity *= shootSpeed;
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), source, velocity, ProjectileID.HeatRay, Projectile.damage, Projectile.knockBack, Projectile.owner);
                    Projectile.ai[0] = 20f;
                }
            }
        }
