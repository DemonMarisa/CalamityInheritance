...
{
    public class SandWaifuMark: ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<SandWaifuTornado>(), Projectile.damage, 2f, Projectile.owner);
            }
