...
{
    public class SandWaifu: ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Summon";
        public int dust = 3;
        public int SandWaifuFrames = 12;

        public override void SetStaticDefaults()
        {
            Main.projFrames[Projectile.type] = SandWaifuFrames;
        ...
        public override void AI()
        {
            ...
            if (!cplr.sandWaifu && !cplr.allWaifus && !cplr.sandWaifuVanity && !cplr.allWaifusVanity)
            {
                Projectile.active = false;
                return;
            }
            bool isMinion = Projectile.type == ModContent.ProjectileType<SandWaifu>();
            if (isMinion)
            {
                if (player.dead)
                {
            ...
            bool passive = cplr.sandWaifuVanity || cplr.allWaifusVanity;
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int projType = ModContent.ProjectileType<SandWaifuBolt>();
