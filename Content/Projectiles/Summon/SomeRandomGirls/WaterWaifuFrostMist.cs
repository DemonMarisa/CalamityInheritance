...
{
    public class WaterWaifuFrostMist: ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Summon";
        public int WaterWaifuFrostMistFramesOriginal = 8;
        public int WaterWaifuFrostMistFramesAlter = 5;
        //同稀有沙元素
        public override void SetStaticDefaults()
        {
            Main.projFrames[Projectile.type] = WaterWaifuFrostMistFramesAlter;
