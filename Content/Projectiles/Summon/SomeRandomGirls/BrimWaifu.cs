...
{
    public class BrimWaifu : ModProjectile, ILocalizedModType
    {
        ...
        {
            bool isActive = Projectile.type == ModContent.ProjectileType<BrimWaifu>();
            Player player = Main.player[Projectile.owner];
            CalamityPlayer calPlayer = player.Calamity();
            if (!calPlayer.brimstoneWaifu && !calPlayer.allWaifus && !calPlayer.brimstoneWaifuVanity && !calPlayer.allWaifusVanity)
            {
            ...
            bool passive = calPlayer.brimstoneWaifuVanity || calPlayer.allWaifusVanity;
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                int projID = ModContent.ProjectileType<BrimWaifuKid>();
        ...
        public override bool? CanDamage()
        {
            Player player = Main.player[Projectile.owner];
            CalamityPlayer CalPlayer = player.Calamity();
            if (CalPlayer.brimstoneWaifuVanity || CalPlayer.allWaifusVanity)
            {
                return false;
            }
            else
