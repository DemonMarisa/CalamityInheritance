...
{
    public class CloudWaifu : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (!calPlayer.cloudWaifu && !calPlayer.allWaifus && !calPlayer.cloudWaifuVanity && !calPlayer.allWaifusVanity)
            {
                Projectile.active = false;
                return;
            }
            bool correctMinion = Projectile.type == ModContent.ProjectileType<CloudWaifu>();
            if (correctMinion)
            {
                if (player.dead)
                {
                    calPlayer.cWaifu = false;
                }
                if (calPlayer.cWaifu)
                {
            ...
            if (!calPlayer.cloudWaifuVanity && !calPlayer.allWaifusVanity)
            {
