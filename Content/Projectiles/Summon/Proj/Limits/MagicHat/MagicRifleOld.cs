...
{
    public class MagicRifleOld : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            float homingRange = MagicHatOld.Range;
            ...
            if (foundTarget)
            {
                ...
                Projectile.rotation = Projectile.rotation.AngleTowards(Projectile.AngleTo(targetVec)
                    + (Projectile.spriteDirection == 1 ? MathHelper.ToRadians(45) : MathHelper.ToRadians(135)), 6f);
            }
            else
            {
            ...
            {
                float projSpeed = 6f;
                int projType = ProjectileType<MagicBulletOld>();
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, projType, Projectile.damage, 0f, Projectile.owner);
