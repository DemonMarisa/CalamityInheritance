...
{
    public class SarosSunfireLegacy : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust bootlegSprite = Dust.NewDustPerfect(Projectile.Center, DustID.CopperCoin);
        ...
        public override void OnKill(int timeLeft) // Makes a dust explosion effect on death.
        {
            ...
            for (int i = 0; i < 60; i++)
            {
                Dust dustExplosion = Dust.NewDustPerfect(Projectile.Center, DustID.CopperCoin);
