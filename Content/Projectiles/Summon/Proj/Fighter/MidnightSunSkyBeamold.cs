...
{
    public class MidnightSunSkyBeamold : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                Dust dust = Dust.NewDustPerfect(beamEndPosiiton, DustID.FrostHydra);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D laserTailTexture = CITextureRegister.MidnightSunBeamBegin.Value;
            Texture2D laserBodyTexture = CITextureRegister.MidnightSunBeamMid.Value;
            Texture2D laserHeadTexture = CITextureRegister.MidnightSunBeamEnd.Value;
