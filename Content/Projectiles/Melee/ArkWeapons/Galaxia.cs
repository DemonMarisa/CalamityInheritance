...
{
    public class Galaxia : CIMeleeProj
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            bool astral = player.CalPlayerInfo().ZoneAstral;
            ...
            if (astral)
            {
                target.AddBuff(BuffType<CIAstralInfection>(), 1200);
                player.AddBuff(BuffType<CIGravityNormalizer>(), 600);
                int proj = Projectile.NewProjectile(Projectile.GetSource_OnHit(target), Projectile.Center, Projectile.velocity, ProjectileType<CIAstralStar>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                Main.projectile[proj].DamageType = DamageClass.Melee;
            }
            else if (jungle)
            {
                target.AddBuff(BuffType<CIPlague>(), 1200);
            ...
            {
                target.AddBuff(BuffType<CICrushDepth>(), 1200);
            ...
            {
                target.AddBuff(BuffType<CIHolyFlames>(), 1200);
            ...
            {
                target.AddBuff(BuffType<CISadness>(), 30);
            ...
            {
                target.AddBuff(BuffType<CIBrimstoneFlames>(), 1200);
            ...
            {
                target.AddBuff(BuffType<CIArmorCrunch>(), 1200);
