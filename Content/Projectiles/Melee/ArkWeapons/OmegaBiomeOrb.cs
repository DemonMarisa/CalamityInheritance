...
{
    public class OmegaBiomeOrb : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            Projectile.HomeInNPC(200f, 24f, 20f);
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (astral)
            {
                target.AddBuff(BuffType<CIAstralInfection>(), 600);
            }
            else if (jungle)
            {
                target.AddBuff(BuffType<CIPlague>(), 600);
            }
            else if (snow)
            {
            ...
            {
                target.AddBuff(BuffType<CIHolyFlames>(), 600);
            }
            else if (glow)
            {
            ...
            {
                target.AddBuff(BuffType<CIBrimstoneFlames>(), 600);
            }
            else if (holy)
            {
                target.AddBuff(BuffType<CIHolyFlames>(), 600);
            ...
            {
                target.AddBuff(BuffType<CIArmorCrunch>(), 600);
            }
        }
    }
}
