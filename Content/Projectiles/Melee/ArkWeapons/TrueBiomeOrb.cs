...
{
    public class TrueBiomeOrb : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            LAPUtilities.HomeInNPC(Projectile, 400f, 24f, 20f);
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (astral)
            {
                target.AddBuff(BuffType<CIAstralInfection>(), 360);
            }
            else if (jungle)
            {
            ...
            {
                target.AddBuff(BuffType<CICrushDepth>(), 360);
            }
            else if (dungeon)
            {
            ...
            {
                target.AddBuff(BuffType<CIArmorCrunch>(), 360);
            }
        }
    }
}
