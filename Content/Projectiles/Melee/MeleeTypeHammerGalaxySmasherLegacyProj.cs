...
{
    [LegacyName("GalaxySmasherHammerOld")]
        ...
        public override bool PreAI()
        {
            if (Main.zenithWorld)
            {
                ...
                if (Projectile.localAI[1] % 15f == 0)
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Projectile.velocity, ModContent.ProjectileType<WTFGalaxy>(), Projectile.damage, 114f);
                //准备返程
