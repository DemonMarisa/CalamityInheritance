...
{
    public class MeleeElementalDiskProj : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => GetInstance<MeleeElementalDisk>().Texture;
        ...
        private void SpawnProjectilesNearEnemies()
        {
            ...
            if (homeIn)
            {
                ...
                {
                    int splitProj = ProjectileType<MeleeElementalDiskProjClone>();
