...
namespace CalamityInheritance.Content.Projectiles.Melee.LightGreadtSword
{
    public class SoulEdgeSoulLegacyMedium : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            if (Main.player[Projectile.owner].active && !Main.player[Projectile.owner].dead)
            {
                ...
                float DistanceToPlayer = LAPUtilities.GetVector2(Projectile.Center, Main.player[Projectile.owner].Center, false).Length();
                if (npc == null && DistanceToPlayer > 900)
                {
                    ...
                    Projectile.HomeInNPC(1500f, 12f, 20f);
            }
            else
            {
        ...
        {
            target.AddBuff(BuffType<CICrushDepth>(), 120);
        }
