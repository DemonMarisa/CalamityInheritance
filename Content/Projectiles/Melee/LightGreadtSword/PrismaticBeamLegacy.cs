...
{
    public class PrismaticBeamLegacy : BaseLaserbeam
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<PrismaticBreakerLegacy>();
        ...
        public override bool PreAI()
        {
            ...
            UpdateAim(rrp);
            Projectile.direction = Owner.LocalMouseWorld().X > Owner.Center.X ? 1 : -1;
        ...
        {
            Vector2 aimVector = Vector2.Normalize(Owner.LocalMouseWorld() - source);
        ...
        {
            target.AddBuff(BuffType<CINightwither>(), 150);
