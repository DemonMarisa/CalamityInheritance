...
{
    public class CorpusAvertorProjLegacyMelee : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => "CalamityInheritance/Content/Items/Weapons/Melee/CorpusAvertorLegacyMelee";
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] < 61f)
            {
                if (Projectile.ai[0] % 20f == 0f)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<CorpusAvertorCloneLegacyMelee>(),
