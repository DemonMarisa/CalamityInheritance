...
{
    public class ElementalDiskProjLegacyMelee : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => "CalamityInheritance/Content/Items/Weapons/Melee/ElementalDiskLegacyMelee";
        ...
        private void SpawnProjectilesNearEnemies()
        {
            ...
            if (homeIn)
            {
                ...
                {
                    int splitProj = ModContent.ProjectileType<ElementalDiskSplitLegacyMelee>();
