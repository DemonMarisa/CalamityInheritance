...
using CalamityInheritance.Content.Items.Weapons.Melee.Throws;
...
{
    public class MeleeCorpusAvertorProjClone : CIMeleeProj
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<MeleeCorpusAvertor>();
        ...
        public override void AI()
        {
            ...
            LAPUtilities.HomeInNPC(Projectile, CorpusAvertorFreakingChasingRange, CorpusAvertorFreakingChasingSpeed, 20f);
        }
