...
{
    public class TerraDiskSmallDiskMeleeLegacy: ModProjectile, ILocalizedModType
    {
        ...
        private void StealthStrikeAI()
        {
            ...
            {
                if (p.identity == Projectile.ai[0] && p.type == ModContent.ProjectileType<TerraDiskProjectileLegacyMelee>())
                {
                    parent = p;
                    active = true;
                    break;
