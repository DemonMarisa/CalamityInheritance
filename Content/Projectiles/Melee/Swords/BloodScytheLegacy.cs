...
{
    public class BloodScytheLegacy : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            NPC potentialTarget = LAPUtilities.FindClosestTarget(Projectile.Center, 540f);
            if (potentialTarget != null)
            {
                ...
                Projectile.velocity = (Projectile.velocity * 14f + LAPUtilities.GetVector2(Projectile.Center, potentialTarget.Center) * flySpeed) / 15f;
