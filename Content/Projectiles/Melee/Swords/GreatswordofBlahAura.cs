            ...
            else
            {
                ...
                if (Projectile.ai[0] > 12f)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), (float)randOrbXOffset, (float)randOrbYOffset, 0f, 10f, ProjectileType<GreatswordofBlahRain>(), Projectile.damage, 0f, Projectile.owner, 0f, 0f);
                    }
                }
            }
