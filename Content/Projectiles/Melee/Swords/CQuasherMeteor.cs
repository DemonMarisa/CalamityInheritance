...
{
    public class CQuasherMeteor : CIMeleeProj
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.Resize((int)(128f * Projectile.scale), (int)(128f * Projectile.scale));
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            LAPUtilities.DrawAfterimages(Projectile, ProjectileID.Sets.TrailingMode[Projectile.type], lightColor, 1, tex);
            return false;
        }
    }
}
