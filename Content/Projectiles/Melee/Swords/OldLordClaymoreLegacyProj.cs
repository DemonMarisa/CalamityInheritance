...
{
    public class OldLordClaymoreLegacyProj : BaseIdleHoldoutProjectile, ILocalizedModType
    {
        ...
        public ref bool RMBChannel => ref (Owner.HeldItem.ModItem as OldLordClaymoreLegacy).RMBchannel;
        ...
        public override string Texture => GetInstance<OldLordClaymoreLegacy>().Texture;
        public override int AssociatedItemID => ItemType<OldLordClaymoreLegacy>();
        public override int IntendedProjectileType => ProjectileType<OldLordClaymoreLegacyProj>();
