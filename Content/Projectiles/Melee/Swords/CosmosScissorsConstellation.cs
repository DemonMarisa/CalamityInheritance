...
{
    public class CosmosScissorsConstellation : ModProjectile, ILocalizedModType
    {
        ...
        Vector2 AnchorEnd => Owner.LocalMouseWorld();
        public Vector2 SizeVector => (AnchorEnd - AnchorStart).SafeNormalize(Vector2.Zero) * MathHelper.Clamp((AnchorEnd - AnchorStart).Length(), 0, CosmosScissors.MaxThrowReach);
