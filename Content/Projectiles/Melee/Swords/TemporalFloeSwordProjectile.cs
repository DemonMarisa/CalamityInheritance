...
{
    public class TemporalFloeSwordProjectile : CIMeleeProj
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, hourVector, ProjectileType<TemporalFloeNumberTwo>(), dmg, kback, Projectile.owner, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, minuteVector, ProjectileType<TemporalFloeNumberTwo>(), dmg, kback, Projectile.owner, 0f, 0f);
        }
