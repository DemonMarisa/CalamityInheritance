...
{
    public class GayBeam : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            switch ((int)Projectile.ai[0])
            {
                ...
                case 4: // Green, home in on enemies
                    ...
                    Projectile.HomeInNPC(600f, MaxVelocity, 30f, null, false);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (!LAPConfig.Instance.PerformanceMode)
            {
                ...
                for (int i = 0; i < totalAfterimages; i++)
                {
                    ...
                    float colorAndSizeScalar = (totalAfterimages - i) / (float)totalAfterimages;
                ...
                case 6: // Cyan
                    ...
                    for (int x = 0; x < 2; x++)
                    {
                        if (Projectile.owner == Main.myPlayer)
                        {
                            ...
                            CIUtils.ProjectileBarrage(source, Projectile.Center, Projectile.Center, x == 1, 500f, 500f, 0f, 500f, MaxVelocity, Projectile.type, (int)Math.Round(Projectile.damage * 0.5), Projectile.knockBack * 0.5f, Projectile.owner, false, 0f).ai[0] = 5f;
                        }
                    }
