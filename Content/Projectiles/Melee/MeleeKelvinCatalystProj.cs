...
{
    public class MeleeKelvinCatalystProj : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => GetInstance<MeleeKelvinCatalyst>().Texture;
            ...
            if (Projectile.owner == Main.myPlayer && Projectile.numHits < maxSpawns)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(),
                                             Projectile.Center,
                                             velocity,
                                             ProjectileType<MeleeKelvinCatalystProjStar>(),
