...
namespace CalamityInheritance.Content.Projectiles.Melee
{
    public class ACTExcelsusBlue : ModProjectile, ILocalizedModType
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(Request<Texture2D>($"{GenericProjRoute.ProjRoute}/Melee/ACTExcelsusBlueGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
        }
