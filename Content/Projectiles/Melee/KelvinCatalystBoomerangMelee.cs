...
{
    public class KelvinCatalystBoomerangMelee : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => "CalamityInheritance/Content/Items/Weapons/Melee/KelvinCatalystMelee";
            ...
            if (Projectile.owner == Main.myPlayer && Projectile.numHits < maxSpawns)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(),
                                             Projectile.Center,
                                             velocity,
                                             ModContent.ProjectileType<KelvinCatalystStarMelee>(),
