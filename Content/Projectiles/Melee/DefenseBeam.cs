        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                for (int i = 0; i < flameAmt; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ProjectileType<DefenseFlame>(), (int)(Projectile.damage * 0.33), 0f, Projectile.owner, 0f, 0f);
                }
            }
        }
    }
