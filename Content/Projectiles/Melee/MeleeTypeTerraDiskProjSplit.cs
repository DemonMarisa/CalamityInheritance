...
{
    [LegacyName("TerraDiskSmallDiskMeleeLegacy")]
    public class MeleeTypeTerraDiskProjSplit: ModProjectile, ILocalizedModType
    {
        ...
        private void StealthStrikeAI()
        {
            ...
            {
                if (p.identity == Projectile.ai[0] && p.type == ModContent.ProjectileType<MeleeTypeTerraDiskProj>())
                {
                    parent = p;
                    active = true;
                    break;
