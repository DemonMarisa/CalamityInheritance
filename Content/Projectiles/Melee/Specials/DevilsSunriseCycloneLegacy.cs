using CalamityInheritance.Content.Items.Weapons.Melee.Specials;
using CalamityMod;
...
namespace CalamityInheritance.Content.Projectiles.Melee.Specials
{
    public class DevilsSunriseCycloneLegacy : ModProjectile, ILocalizedModType
    {
