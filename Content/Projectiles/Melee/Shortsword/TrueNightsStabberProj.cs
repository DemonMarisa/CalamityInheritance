...
namespace CalamityInheritance.Content.Projectiles.Melee.Shortsword
{
    public class TrueNightsStabberProj : BaseShortswordProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 8f, ModContent.ProjectileType<ShortNightBeam>(), (int)(Projectile.damage * 1), Projectile.knockBack, Projectile.owner, 0f, 0f);
        };
