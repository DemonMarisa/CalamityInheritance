...
{
    public class ElementBallShivold : CIMeleeProj
    {
        ...
        {
            LAPUtilities.DrawAfterimages(Projectile, ProjectileID.Sets.TrailingMode[Projectile.type], lightColor, 0);
            return false;
        }
        ...
        private void OnHitEffects(Vector2 targetPos)
        {
            ...
            for (int x = 0; x < 4; x++)
            {
                ...
                {
                    CIUtils.ProjectileBarrage(source, Projectile.Center, targetPos, x > 2, 800f, 800f, 0f, 800f, 1f, ProjectileType<SHIVold>(), Projectile.damage, Projectile.knockBack, Projectile.owner, false, 10f);
                }
            }
        }
    }
