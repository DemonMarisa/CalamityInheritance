...
{
    public class BlueAura : CIMeleeProj
    {
        ...
        {
            SoundEngine.PlaySound(CISounds.AncientShivSounds, Projectile.position);
            CIUtils.DustCircle(Projectile.Center, 24, 1, DustID.MagicMirror, false, 0, 255, 0, 6f);
        }
        ...
        {
            Projectile.HomingTarget(player.Center, -1, 18f, 2f);
        }
    }
}
