...
{
    public class NanoblackSplitLegacyMelee : ModProjectile, ILocalizedModType
    {
        ...
        public float CalcHomingFactor(float dist)
        {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(ModContent.Request<Texture2D>("CalamityInheritance/Content/Projectiles/Melee/NanoblackSplitGlowLegacyMelee").Value,
