...
{
    public class TerraDiskProjectileLegacyMelee: ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => "CalamityInheritance/Content/Items/Weapons/Melee/TerraDiskMeleeLegacy";
        ...
        private void SpawnProjectilesNearEnemies()
        {
            ...
            if (homeIn)
            {
                ...
                {
                    int splitProj = ModContent.ProjectileType<TerraDiskSmallDiskMeleeLegacy>();
