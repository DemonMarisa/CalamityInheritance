...
{
    public class EutrophicScimitarProjLegacy : CIMeleeProj
    {
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i <= 10; i++)
            {
                ...
                dust = Main.dust[Dust.NewDust(position, 58, 58, DustID.Electric, 0f, 0f, 0, new Color(255, 255, 255), 0.4605263f)];
                dust.noGravity = true;
