...
{
    public class ElementalExcaliburBeam : CIMeleeProj
    {
            ...
            switch ((int)Projectile.ai[0])
            {
                ...
                case 3: // Lime, home in on player within certain distance
                    ...
                    if (Main.player[Projectile.owner].active && !Main.player[Projectile.owner].dead)
                    {
                        ...
                        {
                            Vector2 moveDirection = LAPUtilities.GetVector2(Projectile.Center, Main.player[Projectile.owner].Center);
                ...
                case 4: // Green, home in on enemies
                    ...
                    Projectile.HomeInNPC(300f, 6f, 20f, null, !Projectile.tileCollide);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            else if (Projectile.ai[0] == 6f && Projectile.LAP().OnceHitEffect)
            {
                for (int x = 0; x < 3; x++)
                {
                    bool fromRight = x == 1;
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        CIUtils.ProjectileBarrage(source, Projectile.Center, Projectile.Center, fromRight, 500f, 500f, 0f, 500f, 5f, ProjectileType<ElementalExcaliburBeam>(), (int)(Projectile.damage * 0.2), Projectile.knockBack * 0.2f, Projectile.owner, false, 0f).ai[0] = 5f;
                    }
                }
