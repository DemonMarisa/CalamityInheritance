...
{
    public class WulfrumDroidOld : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            if (dust == 0f)
            {
                ...
                for (int dustIndex = 0; dustIndex < dustAmt; dustIndex++)
                {
                    ...
                    int green = Dust.NewDust(source + dustVel, 0, 0, DustID.GreenTorch, dustVel.X * 1.1f, dustVel.Y * 1.1f, 100, default, 1.4f);
            ...
            Main.projectile[bolt].DamageType = DamageClass.Magic;
            Projectile.netUpdate = true;
        }
