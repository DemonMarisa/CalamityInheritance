...
namespace CalamityInheritance.Content.Projectiles.Ranged.Cannos
{
    public class MegafleetProj : ModProjectile, ILocalizedModType
    {
        ...
        {
            LAPUtilities.DrawAfterimages(Projectile, ProjectileID.Sets.TrailingMode[Type], lightColor, 1);
            return false;
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ProjectileType<PlasmaExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, Main.rand.Next(0, 4));
            }
