...
{
    public class ChargedBlastLegacy2 : CIRangedProj
    {
        ...
        public override void AI()
        {
            ...
            Projectile.HomeInNPC(2500f, 18f, 150f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                LineParticle spark2 = new LineParticle(Projectile.Center, (Projectile.velocity * 5).RotatedByRandom(0.4f) * Main.rand.NextFloat(0.8f, 1.2f), false, Main.rand.Next(8, 11 + 1), Main.rand.NextFloat(0.5f, 1f), baseColor);
                spark2.Spawn();
            }
        }
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) => LAPUtilities.CircularHitboxCollision(Projectile.Center, 10, targetHitbox);
