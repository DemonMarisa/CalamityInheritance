    ...
    public class ChargedBlastLegacy : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, Main.rand.Next(-10, 11) * 2f, Main.rand.Next(-10, 11) * 2f, ModContent.ProjectileType<ChargedBlastLegacy2>(),
