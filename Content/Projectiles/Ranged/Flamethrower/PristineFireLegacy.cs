...
{
    public class PristineFireLegacy : CIRangedProj
    {
        public override string Texture => LAPTextureRegister.InvisibleTexturePath;

        private int dust1 = 244;
        private int dust2 = DustType<CIHolyFireDust>();
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] > 5f)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    Main.dust[dType].color = CIUtils.ColorSwap(new Color(255, 168, 53), new Color(255, 249, 0), 2f);
                }
                Projectile.ai[0] += 1f;
                ...
                else
                {
                    ...
                    for (int j = 0; j < 2; j++)
                    {
                        ...
                        Main.dust[dGet].color = CIUtils.ColorSwap(new Color(255, 168, 53), new Color(255, 249, 0), 2f);
                    }
                }
            }
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                dust.color = CIUtils.ColorSwap(new Color(255, 168, 53), new Color(255, 249, 0), 2f);
