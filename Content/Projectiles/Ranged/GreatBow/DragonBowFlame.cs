...
namespace CalamityInheritance.Content.Projectiles.Ranged.GreatBow
{
    public class DragonBowFlame : CIRangedProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 2f)
            {
                ...
                Projectile.HomeInNPC(1800f, homingSpeed, inhertiaSpeed);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D13, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Rectangle?(new Rectangle(0, 0, texture2D13.Width, texture2D13.Height)), Projectile.GetAlpha(lightColor), Projectile.rotation, new Vector2(texture2D13.Width / 2f, texture2D13.Height / 2f), Projectile.scale, SpriteEffects.None, 0);
            return false;
        }
        ...
        {
            target.AddBuff(BuffType<CIDragonfire>(), 240);
