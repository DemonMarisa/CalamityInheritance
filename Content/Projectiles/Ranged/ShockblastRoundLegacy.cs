...
namespace CalamityInheritance.Content.Projectiles.Ranged
{
    public class ShockblastRoundLegacy : ModProjectile, ILocalizedModType
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            {
                int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ShockblastLegacy>(), Projectile.damage, 0f, Projectile.owner, 0f, Projectile.ai[1]);
