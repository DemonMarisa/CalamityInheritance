...
{
    public class ShockblastLegacy : CIRangedProj
    {
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) => LAPUtilities.CircularHitboxCollision(Projectile.Center, Projectile.width * Projectile.scale * 4.5f, targetHitbox);
