...
{
    public class ChickenRound : CIRangedProj
    {
        ...
        {
            Projectile.frame = Projectile.FramesChanger(FramesCounter, MaxFrames);
        ...
        {
            int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ProjectileType<ChickenExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
