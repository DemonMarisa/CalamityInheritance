using CalamityInheritance.Content.Items.Weapons.Ranged.StarCannon;
...
{
    public class StarfleetMK2GunLegacy : ModProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<StarmadaLegacy>();
        public override string Texture => GetInstance<StarmadaLegacy>().Texture;
