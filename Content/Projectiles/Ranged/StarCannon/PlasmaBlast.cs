...
{
    public class PlasmaBlast : CIRangedProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] == 12f)
            {
                ...
                for (int l = 0; l < 12; l++)
                {
                    ...
                    dustVel += -Vector2.UnitY.RotatedBy((double)(l * MathHelper.Pi / 6f), default) * new Vector2(8f, 16f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ProjectileType<PlasmaExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
