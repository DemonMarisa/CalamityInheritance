...
namespace CalamityInheritance.Content.Projectiles.Ranged
{
    public class ProfanedNukeDust: ModProjectile, ILocalizedModType
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(BuffType<HolyFlames>(), 120);
        public override void OnHitPlayer(Player target, Player.HurtInfo info) => target.AddBuff(BuffType<HolyFlames>(), 120);
    }
}