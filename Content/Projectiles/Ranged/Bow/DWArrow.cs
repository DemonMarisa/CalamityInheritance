...
{
    public class DWArrow : CIRangedProj
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                dusty.position -= Projectile.velocity / 5f * i;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            ModProjectile DWArrow = ProjectileLoader.GetProjectile(ProjectileType<DWArrow>());
            Texture2D texture;
            switch (Projectile.localAI[1])
            {
                case 2f:
                    texture = Request<Texture2D>($"{DWArrow.Texture}" + 2).Value;
                    break;
                default:
                    texture = Request<Texture2D>($"{DWArrow.Texture}").Value;
                    break;
            }
