...
{
    public class UrchinBall : CIMeleeProj
    {
        ...
        public override void AI()
        {
            ...
            player.itemRotation = (projDirection * -1f * Projectile.direction).ToRotation();
            ...
            if (Projectile.ai[0] == 1f || Projectile.ai[0] == 2f)
            {
                ...
                {
                    spike = false;
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ProjectileType<UrchinBallSpike>(), (int)(Projectile.damage * 0.5), 0f, Main.myPlayer, 0f, 0f);
                }
