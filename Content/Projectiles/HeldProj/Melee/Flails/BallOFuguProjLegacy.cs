...
{
    public class BallOFuguProjLegacy : CIMeleeProj
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<BallOFuguLegacy>();
        ...
        public override void AI()
        {
            ...
            player.itemRotation = (projVector * -1f * Projectile.direction).ToRotation();
            ...
            if (Projectile.ai[1] % 6f == 0f && Projectile.owner == Main.myPlayer)
            {
                ...
                spikeVector *= Main.rand.Next(45, 65) * 0.1f;
                spikeVector = spikeVector.RotatedBy((Main.rand.NextDouble() - 0.5) * 1.5707963705062866, default);
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, spikeVector.X, spikeVector.Y, ProjectileType<UrchinSpikeFuguLegacy>(), (int)(Projectile.damage * 0.6), Projectile.knockBack * 0.2f, Projectile.owner, -10f, 0f);
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float drawRotation = (float)Math.Atan2(actualCenter.Y, actualCenter.X) - MathHelper.PiOver2;
            bool isActive = true;
