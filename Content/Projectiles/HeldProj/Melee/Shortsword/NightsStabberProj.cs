...
{
    public class NightsStabberProj : CIBaseShortswordProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<NightsStabber>();
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 6f, ProjectileType<NIghtOrb>(), Projectile.damage * 1, Projectile.knockBack, Projectile.owner, 0f, 0f);
        };
