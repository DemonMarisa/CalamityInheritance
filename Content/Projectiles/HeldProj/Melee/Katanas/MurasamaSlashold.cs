...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.Katanas
{
    public class MurasamaSlashold : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                int redDust = Dust.NewDust(origin - Projectile.Size / 2f, Projectile.width, Projectile.height, DustID.LifeDrain, Projectile.velocity.X, Projectile.velocity.Y, 100, default, 2f);
