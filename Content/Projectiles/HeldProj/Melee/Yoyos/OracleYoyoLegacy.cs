...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.Yoyos
{
    public class OracleYoyoLegacy : ModProjectile
    {
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) => LAPUtilities.CircularHitboxCollision(Projectile.Center, OrigHitBoxSize + HitBoxSize, targetHitbox);
    }
}
