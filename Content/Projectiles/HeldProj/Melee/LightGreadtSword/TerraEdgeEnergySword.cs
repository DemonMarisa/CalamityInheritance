...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.LightGreadtSword
{
    public class TerraEdgeEnergySword : ModProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<TerraEdge>();
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 3f < Projectile.Opacity)
            {
                ...
                Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), DustID.GreenTorch, dustVelocity * 1f, 100, dustColor, 0.4f);
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, Color.SpringGreen * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(20, 180, 40); // 原始圣剑颜色：Color(180, 160, 60)
            Color middleMediumColor = new Color(80, 255, 80); // 原始圣剑颜色：Color(255, 255, 80)
            Color frontLightColor = new Color(80, 200, 255); // 原始圣剑颜色：Color(255, 240, 150)
