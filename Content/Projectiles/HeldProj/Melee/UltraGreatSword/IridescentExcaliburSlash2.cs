...
{
    public class IridescentExcaliburSlash2 : ModProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<IridescentExcalibur>();
        public override string Texture => GetInstance<IridescentExcaliburSlash>().Texture;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            color4.A = (byte)(color4.A * (1f - fromValue) * 0.5f);
