...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.GreatSwords
{
    public class TrueBloodyEdgeEnergySword : ModProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<TrueBloodyEdge>();
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            TrueBloodyEdgeSpark.GeneratePrettySparkles(position, scale, 0);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(150, 15, 15); // 原始圣剑颜色：Color(180, 160, 60)
            Color middleMediumColor = new Color(180, 180, 20); // 原始圣剑颜色：Color(255, 255, 80)
            Color frontLightColor = new Color(200, 25, 0); // 原始圣剑颜色：Color(255, 240, 150)
