...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.GreatSwords.OldLord
{
    public class OldLordOathswordLegacyHeld_C : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            Owner.CI().CanUseOldLordDash = false;
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Dust fire = Dust.NewDustPerfect(dustSpawnPosition, DustID.Torch, dustVelocity);
                fire.scale = 1.7f;
                fire.noGravity = true;
            }
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                Owner.velocity = Vector2.Lerp(Owner.velocity, LAPUtilities.GetVector2(Owner.Center, Owner.LocalMouseWorld()) * 32f * VelMult, 0.125f);
