...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Melee.GreatSwords.OldLord
{
    public class OldLordOathswordLegacyHeld : ModProjectile, ILocalizedModType
    {
        ...
        {
            CanHit = false;
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Vector2.Zero, ProjectileID.SolarWhipSwordExplosion, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0.85f + Main.rand.NextFloat() * 1.15f);
        }
