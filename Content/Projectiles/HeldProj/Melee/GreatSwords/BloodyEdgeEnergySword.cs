...
{
    public class BloodyEdgeEnergySword : ModProjectile
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<BloodyEdge>();
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            BloodyEdgeSpark.GeneratePrettySparkles(position, speed, 0);
