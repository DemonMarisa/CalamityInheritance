...
{
    public class ACTGenisisHeldProj : BaseHeldProj, ILocalizedModType
    {
        ...
        public override void HoldoutAI()
        {
            ...
            if (Projectile.ai[2] == 0f)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + fireOffset, Projdirection * 0.001f, ModContent.ProjectileType<AlphaBeam>(), Projectile.damage, Projectile.knockBack, Owner.whoAmI, 1f, 0f, 0f);
                Projectile.ai[2]++;
            }
            if (attackTimer % 30 == 0)
            {
