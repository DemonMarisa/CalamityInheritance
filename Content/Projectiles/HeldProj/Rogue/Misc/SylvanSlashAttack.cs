...
using CalamityInheritance.Content.Items.Weapons.Rogue.Misc;
...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Rogue.Misc
{
    public class SylvanSlashAttack : CIRogueProj
    {
