...
using CalamityInheritance.Content.Items.Weapons.Ranged.GreatBow;
...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Ranged.GreatBow
{
    public class DragonBow : CIRangedProj
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<DrataliornusLegacy>();
        ...
        public override void AI() //mostly phangasm code
        {
            ...
            if (timeToFire && Main.myPlayer == Projectile.owner)
            {
                if (canFire) //fire an angery flame
                {
                    ...
                    type = ProjectileType<DragonBowFlame>();
