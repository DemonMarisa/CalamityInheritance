...
namespace CalamityInheritance.Content.Projectiles.HeldProj.Ranged.StarCannon
{
    public class NorfleetCannonLegacy : CIRangedProj
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<NorfleetLegacy>();
