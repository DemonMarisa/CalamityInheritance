...
{
    public class BloodfireArrowProjLegacy : CIAmmoProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 15 == 0)
            {
                for (int l = 0; l < 12; l++)
                {
                    ...
                    int num9 = Dust.NewDust(Projectile.Center, 0, 0, DustID.LifeDrain, 0f, 0f, 160, default, 1f);
            ...
            Projectile.HomeInNPC(900, 12, 20, null, !Projectile.tileCollide);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int num622 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, LAPDustID.DustLifeDrain, 0f, 0f, 100, default, 2f);
