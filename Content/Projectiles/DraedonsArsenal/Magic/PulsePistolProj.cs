...
{
    public class PulsePistolProj : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            if (Time >= 10f || NPCsAlreadyHit.Count > 0)
            {
                ...
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.BoneTorch);
                dust.noGravity = true;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            ((PulsePistolProj)splitShot.ModProjectile).NPCsAlreadyHit.AddRange(NPCsAlreadyHit);
            ((PulsePistolProj)splitShot.ModProjectile).NPCsAlreadyHit.Add(toHit);
            Projectile.Kill();
        }
    }
}
