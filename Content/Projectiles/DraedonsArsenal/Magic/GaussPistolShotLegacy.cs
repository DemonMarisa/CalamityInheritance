...
{
    public class GaussPistolShotLegacy : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            if (Time >= ChargeTime && OldVelocity != Vector2.Zero)
            {
                Projectile.velocity = LAPUtilities.GetVector2(Projectile.Center, Projectile.Owner().LocalMouseWorld()) * OldVelocity.Length(); ;
