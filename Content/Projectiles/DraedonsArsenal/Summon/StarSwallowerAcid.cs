...
{
    public class StarSwallowerAcid : CISummonProj
    {
        ...
        public override void AI()
        {
            ...
            Projectile.HomeInNPC(300f, 12f, 20f);
        }
        ...
        {
            LAPUtilities.DrawAfterimages(Projectile, ProjectileID.Sets.TrailingMode[Projectile.type], new Color(255, 255, 255, 127) * Projectile.Opacity, 2);
            return false;
        }
    }
}
