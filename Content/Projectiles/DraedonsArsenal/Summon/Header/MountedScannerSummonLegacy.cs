...
{
    public class MountedScannerSummonLegacy : CISummonProj
    {
        ...
        public const float LaserFireRate = 80f;
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.minionSlots = Main.zenithWorld ? 0.5f : 1.25f;
        ...
        public void GrantBuffs(Player player)
        {
            ...
            player.AddBuff(BuffType<MountedScannerLegacyBuff>(), 2);
        ...
        public void AttackTarget(NPC target)
        {
            ...
            if (Time % LaserFireRate == LaserFireRate - 1f)
            {
                if (Projectile.owner == Main.myPlayer)
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, LAPUtilities.GetVector2(Projectile.Center, target.Center), ProjectileType<MountedScannerLaserLegacy>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, Projectile.whoAmI);

                SoundEngine.PlaySound(CISounds.LaserCannon, Projectile.Center);
            }
        }
