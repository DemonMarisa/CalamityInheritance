...
{
    public class UnstableMatter : CIRangedProj
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            if (!HasCollidedWithATile)
            {
                ...
                NPC potentialTarget = LAPUtilities.FindClosestTarget(Projectile.Center, 1200, false);
                if (potentialTarget != null)
                    Projectile.velocity = LAPUtilities.GetVector2(Projectile.Center, potentialTarget.Center);
                else
                {
