        ...
        private void OnHitEffects(int targetIndex, int health, bool specialEffects)
        {
            ...
            if (PanType == SearedPanTypes.StealthStrike)
            {
                ...
                for (int t = 0; t < 4; t++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<FlameLegacy>(), (int)(Projectile.damage * 0.2), 0f, Projectile.owner);
                }
