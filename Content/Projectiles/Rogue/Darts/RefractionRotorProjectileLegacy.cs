...
{
    public class RefractionRotorProjectileLegacy : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Rogue";
        public const int EnergyShotCount = 6;
        public override string Texture => GetInstance<RefractionRotorLegacy>().Texture;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int bladeType = ModContent.ProjectileType<PrismShurikenBladeLegacy>();
