...
{
    public class DragonSpearProj : CIRogueProj
    {
        ...
        public override void AI()
        {
            ...
            Projectile.frame = CIUtils.FramesChanger(Projectile, 6, 4);
            Projectile.rotation = (float)Math.Atan2(Projectile.velocity.Y, Projectile.velocity.X) + 0.785f;
            LAPUtilities.HomeInNPC(Projectile, 800f, 25f, 20f, null, false);
        }
