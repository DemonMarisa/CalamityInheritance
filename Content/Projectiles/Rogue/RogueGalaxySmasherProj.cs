...
{
    public class RogueGalaxySmasherProj : ModProjectile, ILocalizedModType
    {
        ...
        private void StealthOnHit(NPC target)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Projectile.velocity, ProjectileType<RogueGalaxySmasherProjClone>(), Projectile.damage, Projectile.knockBack, Main.myPlayer, target.whoAmI);
