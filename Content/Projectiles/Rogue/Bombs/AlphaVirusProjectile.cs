...
{
    public class AlphaVirusProjectile : CIRogueProj
    {
        public override string Texture => GetInstance<AlphaVirus>().Texture;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<CIPlague>(), 120);
            }
        }
        ...
        {
            // Aura effect
            Texture2D aura = CIProjectiles_Rogue.AlphaVirusAura.Value;
