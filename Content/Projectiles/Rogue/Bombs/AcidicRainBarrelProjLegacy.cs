...
{
    public class AcidicRainBarrelProjLegacy : CIRogueProj
    {
        public override string Texture => GetInstance<AcidicRainBarrel>().Texture;
        ...
        {
            bool stealthS = Projectile.CI().Stealth;
        ...
        public void BounceEffects()
        {
            ...
            if (stealthS)
            {
                projectileCount += 8; //more shit the closer we are to death
            }
            for (int i = 0; i < projectileCount; i++)
            {
                ...
                else
                {
                    ...
                    int acidIndex = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity + acidVelocity,
                        ...
                        (int)(Projectile.damage), 1f, Projectile.owner);
                    Main.projectile[acidIndex].DamageType = RogueDamage.Instance;
