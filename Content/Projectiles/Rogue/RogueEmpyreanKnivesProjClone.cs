...
{
    public class RogueEmpyreanKnivesProjClone : ModProjectile, ILocalizedModType
    {
        public override string Texture => GetInstance<RogueEmpyreanKnivesProj>().Texture;
        ...
        public void DoReturning()
        {
            ...
            {
                int healdamage = Owner.DamageBoostApply<RogueDamageClass>(RogueEmpyreanKnives.BaseDamage);
