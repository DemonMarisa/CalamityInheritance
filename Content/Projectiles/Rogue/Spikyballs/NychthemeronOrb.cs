...
{
    public class NychthemeronOrb : CIRogueProj
    {
        ...
        public override void AI()
        {
            ...
            {
                if (Projectile.timeLeft > 240 && Projectile.localAI[2] == 1)
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texDark = ModContent.Request<Texture2D>($"{Texture}" + 2).Value;
