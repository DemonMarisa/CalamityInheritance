...
{
    public class MoltenAmputatorProjLegacy : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => GetInstance<MoltenAmputatorLegacy>().Texture;
        ...
        private void SpawnBlobs(int blobCount)
        {
            for (int i = 0; i < blobCount; i++)
            {
                ...
                int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, iAmSpeed.X, iAmSpeed.Y, ModContent.ProjectileType<HolyFireLegacy>(), (int)(Projectile.damage * 0.25), 0f, Projectile.owner, 0f, 0f);
                Main.projectile[p].DamageType = RogueDamageClass.Instance;
            }
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= FramesBeforeReturning)
            {
                float returnSpeed = MoltenAmputatorLegacy.Speed * 4f;
