...
{
    public class RogueTerraDiskProj : RogueDamageProj
    {
        public override string Texture => GetInstance<RogueTerraDisk>().Texture;
                ...
                if (Main.player[Projectile.owner].miscCounter % 50 == 0)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        for (int i = 0; i < 6; i++)
                        {
                            ...
                            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ProjectileType<RogueTerraDiskProjSmall>(), Projectile.damage / 2, Projectile.knockBack * 0.5f, Projectile.owner);
                        }
                    }
                }
            }
