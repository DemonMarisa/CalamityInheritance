...
{
    public class EquanimityProjLegacy : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Content.Projectiles.Melee";
        public override string Texture => GetInstance<EquanimityLegacy>().Texture;
        ...
        public override void AI()
        {
            ...
            if (recall)
            {
                if (Main.rand.Next(0, 10) == 0)
                {
                    ...
                    shardVelocity *= 5f;
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, shardVelocity, ProjectileType<EquanimityDarkShardLegacy>(), (int)(Projectile.damage * 0.8f), 0f, Projectile.owner);
                    if (Projectile.Calamity().stealthStrike)
                    {
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, -shardVelocity, ProjectileType<EquanimityLightShardLegacy>(), (int)(Projectile.damage * 0.8f), 0f, Projectile.owner);
                    }
                }
