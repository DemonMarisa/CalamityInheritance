...
{
    public class EradicatorProj_Rogue : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Projectiles.Rogue";
        public override string Texture => GetInstance<Eradicator_Rogue>().Texture;
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft <= Lifetime - ReboundTime)
            {
                float returnSpeed = Eradicator_Rogue.Speed * 1.3f;
