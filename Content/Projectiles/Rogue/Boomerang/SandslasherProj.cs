...
{
    public class SandslasherProj : CIRogueProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.CI().Stealth && Projectile.ai[1] >= 5f)
            {
                Vector2 speed = new Vector2(Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-2f, 2f));
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, speed, ProjectileType<DuststormCloudLegacy>(), (int)(Projectile.damage * 0.4), 0f, Projectile.owner);
                Projectile.ai[1] = 0;
            }
        }
