...
{
    public class OricGemstoneProj : CIRogueProj
    {
        public bool MouseRight => Projectile.ai[1] != 0;
        ...
        {
            CIUtils.DustCircle(Projectile.Center, 32, 1.4f, DustID.Orichalcum, false, 16f);
        ...
        public void HitEffect(Vector2 finalPosition, int totalCount = 2)
        {
            if (Main.myPlayer != Projectile.owner)
                return;
            totalCount = Projectile.CI().Stealth ? totalCount : 1;
            ...
            for (int i = 0; i < totalCount; i++)
            {
                ...
                Main.projectile[petal].DamageType = RogueDamage.Instance;
            }
        }
