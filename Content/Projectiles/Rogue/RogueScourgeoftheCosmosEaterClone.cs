...
{
    public class RogueScourgeoftheCosmosEaterClone : ModProjectile, ILocalizedModType
    {
        public override string Texture => GetInstance<RogueScourgeoftheCosmosEater>().Texture;
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(Request<Texture2D>("CalamityMod/Projectiles/Melee/ScourgeoftheCosmosMiniGlow").Value, Projectile.Center - Main.screenPosition, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, texture2D13.Width, framing)), Color.White, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < minisAmt; j = inc + 1)
            {
                ...
                randXDirect *= 10f;
                randYDirect *= 10f;
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, randXDirect, randYDirect, ProjectileType<RogueScourgeoftheCosmosEater>(), (int)(Projectile.damage * 0.45f), Projectile.knockBack * 0.35f, Main.myPlayer, 10f);
                inc = j;
            }
