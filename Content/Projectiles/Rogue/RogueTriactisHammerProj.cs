...
{
    public class RogueTriactisHammerProj : ModProjectile, ILocalizedModType
    {
        ...
        {
            //普攻与潜伏共享的效果: 爆炸
            int boom = ProjectileType<RogueTriactisHammerProjBoom>();
            ...
            if(Projectile.Calamity().stealthStrike)
            {
                ...
                if(ifSummonClone) 
                {
                    ...
                    SpawnSparks(hit);
                    int pTyoe = ProjectileType<RogueTriactisHammerProjClone>();
