...
{
    public class RogueEmpyreanKnivesProj : ModProjectile, ILocalizedModType
    {
        ...
        {
            Projectile.Owner().SpawnLifeStealProj(target, Projectile, ProjectileType<StandardHealProj>(), -1);
        }
