...
{
    public class RogueTriactisHammerProjClone : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            int projID = ProjectileType<RogueTriactisHammerProj>();
            float IsReturning = RogueTriactisHammerProj.IsReturning;
            float isClone = RogueTriactisHammerProj.OnHangingBack;
        ...
        private void SpawnExplosion()
        {
            ...
            {
                int explo = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ProjectileType<RogueTriactisHammerProjBoom>(), (int)(Projectile.damage * 0.25), Projectile.knockBack, Projectile.owner, 0f, 0f);
        ...
        {
            int hammerType = ProjectileType<RogueTriactisHammerProjEcho>();
