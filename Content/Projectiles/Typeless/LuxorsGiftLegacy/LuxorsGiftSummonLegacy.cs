...
namespace CalamityInheritance.Content.Projectiles.Typeless.LuxorsGiftLegacy
{
    public class LuxorsGiftSummonLegacy : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (!player.CIMod().LuxorsGiftLegacy || player.dead)
            {
                Projectile.Kill();
            }
