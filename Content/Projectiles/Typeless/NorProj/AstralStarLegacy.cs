    ...
    public class AstralStarLegacy : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(16))
            {
                ...
                int astralDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<AstralOrange>(), Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default, 1f);
            ...
            if (Projectile.ai[1] == 1f)
            {
                ...
                if (Main.rand.NextBool(10))
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<AstralOrange>(), Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default, 1f);
