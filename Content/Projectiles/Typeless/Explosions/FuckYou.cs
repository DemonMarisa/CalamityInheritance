...
{
    public class FuckYou : CITypelessProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1f)
            {
                ...
                for (int dustIndexA = 0; dustIndexA < 4; dustIndexA = incrementer + 1)
                {
                    ...
                    Main.dust[smoky].position = Projectile.Center + Vector2.UnitY.RotatedByRandom(Math.PI) * (float)Main.rand.NextDouble() * Projectile.width / 2f;
                ...
                for (int dustIndexC = 0; dustIndexC < 5; dustIndexC = incrementer + 1)
                {
                    ...
                    dust.position = Projectile.Center + Vector2.UnitX.RotatedByRandom(Math.PI).RotatedBy((double)Projectile.velocity.ToRotation(), default) * Projectile.width / 2f;
                    dust.noGravity = true;
                    dust.velocity *= 3f;
