    ...
    public class ShizukuEdgeProjectile : ModProjectile, ILocalizedModType
    {
       ...
       public override void AI()
       {
        ...
        public void ShouldSpin()
        {
            ...
            Projectile.rotation = RotatedToAngle(Projectile.rotation, Projectile.rotation + MathHelper.Pi, 0.7f);
            if (SpinTimer > 70f)
                SpinTimer = 0f;
        }
       ...
       public void FollowingYourMouse()
       {
           if (Projectile.owner != Main.myPlayer)
            ...
            {
                CIFunction.HomeInOnMouseBetter(Projectile, 16f, 20f, 1, true);
                Projectile.velocity = (Projectile.velocity * 3f + Projectile.DirectionTo(Main.MouseWorld) * 17f) / 4f;
