...
namespace CalamityInheritance.Content.Projectiles.Typeless.Weapon.Attack
{
    public class AncientMurasamaProj : CITypelessProj
    {
        ...
        public override void AI()
        {
            ...
            {
                int num30 = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, DustID.LifeDrain, Projectile.velocity.X, Projectile.velocity.Y, 100, default, 2f);
