...
namespace CalamityInheritance.Content.Projectiles.Tools
{
    public class CrystylCrusherRay : ModProjectile, ILocalizedModType
    {
        public override LocalizedText DisplayName => LAPUtilities.GetItemName<CrystylCrusherLegacy>();
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 300)
                SoundEngine.PlaySound(CISounds.CrystylCharge, player.Center);
