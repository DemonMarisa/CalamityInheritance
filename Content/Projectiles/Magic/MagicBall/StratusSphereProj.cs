...
namespace CalamityInheritance.Content.Projectiles.Magic.MagicBall
{
    public class StratusSphereProj : CIMagicProj
    {
        int roundsGone = 0;
        int dust_nut = 0;
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Projectile.ai[1] > 40)
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, LAPUtilities.GetVector2(Projectile.Center, targetDir) * 12f, ProjectileType<Crescent>(), Projectile.damage / 2, 0.4f, Projectile.owner, Projectile.whoAmI);
            ...
            if (dust_nut > 22)
            {
                ...
                for (int i = 0; i < num20; i++)
                {
                    ...
                    spinningpoint = spinningpoint.RotatedBy((double)((i - (num20 / 2 - 1)) * 6.28318548f / num20), default) + Projectile.Center;
            ...
            LAPUtilities.HomeInNPC(Projectile, 1500, 7, 7);
        }
