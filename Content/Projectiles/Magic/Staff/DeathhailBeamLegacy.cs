...
{
    public class DeathhailBeamLegacy : BaseLaserbeam, ILocalizedModType
    {
        ...
        public override Color LaserOverlayColor => CIUtils.ColorSwap(startingColor, secondColor, 0.9f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(BuffType<CIGodSlayerInferno>(), 180);

        public override void OnHitPlayer(Player target, Player.HurtInfo info) => target.AddBuff(BuffType<CIGodSlayerInferno>(), 180);
    }
}
