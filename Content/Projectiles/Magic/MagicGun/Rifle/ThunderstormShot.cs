...
{
    public class ThunderstormShot : CIMagicProj
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.ai[1] == 0f)
            {
                for (int n = 0; n < 5; n++)
                {
                    Projectile proj = CIUtils.ProjectileRain(source, Projectile.Center, 200f, 100f, 1500f, 1500f, 29f, Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
                    proj.ai[1] = 1;
                    proj.MaxUpdates = 20;
