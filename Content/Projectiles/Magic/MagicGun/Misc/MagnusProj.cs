...
namespace CalamityInheritance.Content.Projectiles.Magic.MagicGun.Misc
{
    public class MagnusProj : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            LAPUtilities.HomeInNPC(Projectile, 1500f, 24f, 70f, null, false);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.Resize(height, height);
