...
{
    public class InfernadoFriendlyold : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] == 0f)
            {
                ...
                Projectile.Resize((int)(baseWidth * Projectile.scale), (int)(baseHeight * Projectile.scale));
            ...
            if (Projectile.ai[0] <= 0f)
            {
                ...
                float smolWidth = Projectile.width / 5f;
                smolWidth *= 2f;
