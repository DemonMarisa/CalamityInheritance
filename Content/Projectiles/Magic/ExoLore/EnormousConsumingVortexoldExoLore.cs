        ...
        public void ExplodeEffect()
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int j = 0; j < 18; j++)
                {
                    ...
                    Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(null), Projectile.Center, velocity2, ModContent.ProjectileType<VortexExoLore>(), (int)(Projectile.damage * 0.7), this.Projectile.knockBack, this.Projectile.owner, 0f, Utils.NextFloat(Main.rand, 0.5f, 1.8f), 0f);
                }
            }
        }
