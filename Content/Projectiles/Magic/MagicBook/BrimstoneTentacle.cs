...
{
    public class BrimstoneTentacle : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.scale < 1f && Projectile.localAI[1] > 5f)
            {
                ...
                {
                    int brimDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.LifeDrain, Projectile.velocity.X, Projectile.velocity.Y, 100, default, 1.5f);
                    ...
                    Main.dust[brimDust].fadeIn = 100 + Projectile.owner;
