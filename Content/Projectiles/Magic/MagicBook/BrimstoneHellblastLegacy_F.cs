...
{
    public class BrimstoneHellblastLegacy_F : CIMagicProj
    {
        public static readonly SoundStyle FireSound = CISounds.HellblastFire;
        ...
        {
            target.AddBuff(BuffType<CIBrimstoneFlames>(), 30);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.LifeDrain, 0f, 0f);
            }
        }
    }
}
