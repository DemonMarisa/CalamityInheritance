...
{
    public class HellfireExplosion_F : CIMagicProj
    {
        ...
        public override void AI()
        {
            ...
            while ((float)timerCounter < projTimer)
            {
                ...
                int brimDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, LAPDustID.DustVampireHeal, 0f, 0f, 100, default, 1.5f);
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            target.AddBuff(ModContent.BuffType<CIBrimstoneFlames>(), 150);
        }
    }
}
