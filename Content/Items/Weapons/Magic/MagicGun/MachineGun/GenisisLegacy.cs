...
using CalamityInheritance.Content.Projectiles.Magic.MagicGun.MachineGun;
...
namespace CalamityInheritance.Content.Items.Weapons.Magic.MagicGun.MachineGun
{
    public class GenisisLegacy : CIMagic
    {
