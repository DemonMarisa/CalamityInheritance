...
{
    public class EmpyreanKnivesLegacyRogue : RogueWeapon, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.useTime = 8; //使用时间15->8, 面板伤害360->200
            Item.knockBack = 3f;
            Item.UseSound = SoundID.Item39;
            Item.autoReuse = true;
            Item.value = CIShopValue.RarityPriceDeepBlue;
            Item.rare = ModContent.RarityType<DeepBlue>();
            Item.shoot = ModContent.ProjectileType<EmpyreanKnivesProjectileLegacyRogue>();
            Item.shootSpeed = 15f;
        }
