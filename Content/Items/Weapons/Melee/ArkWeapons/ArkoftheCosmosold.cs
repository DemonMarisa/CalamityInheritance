...
{
    public class ArkoftheCosmosold : CIMelee
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int fireCount = 0; fireCount < totalFire; fireCount++)
            {
                ...
                int projectileFire = Projectile.NewProjectile(source, finalPos, newVelocity, ProjectileType<Galaxia>(), damage, knockback, player.whoAmI, 0f, Main.rand.Next(3));
