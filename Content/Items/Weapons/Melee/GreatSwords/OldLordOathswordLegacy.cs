...
using CalamityInheritance.Content.Projectiles.HeldProj.Melee.GreatSwords.OldLord;
...
{
    public class OldLordOathswordLegacy : CIMelee
    {
        public int Filp = 1;
        ...
        {
            if (player.CI().CanUseOldLordDash)
            {
                ...
                player.CI().CanUseOldLordDash = false;
                return false;
            }
