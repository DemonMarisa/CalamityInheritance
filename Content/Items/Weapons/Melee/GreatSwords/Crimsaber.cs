...
{
    public class Crimsaber : CIMelee
    {
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                int p = Projectile.NewProjectile(player.GetSource_OnHit(target), vector2.X, vector2.Y, speedX4, speedY5, ProjectileID.GoldenShowerFriendly, hit.Damage, hit.Knockback, player.whoAmI, 1f, Main.rand.Next(10));
