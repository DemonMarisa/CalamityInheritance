...
using CalamityInheritance.Content.Projectiles.Melee.Reaper;
...
namespace CalamityInheritance.Content.Items.Weapons.Melee.Reaper
{
    public class BalefulHarvesterLegacy : CIMelee
    {
