...
{
    public class EarthExtraProj : CIMeleeProj
    {
        private int noTileHitCounter = 120;
        public override string Texture => CIProjectiles_Melee.Earth1.Path;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Style == 0)
            {
                texture = CIProjectiles_Melee.Earth1.Value;
            }
            else if (Style == 1)
            {
                texture = CIProjectiles_Melee.Earth2.Value;
            }
            else
            {
                texture = CIProjectiles_Melee.Earth3.Value;
            }
            Projectile.BaseProjPreDraw(texture, lightColor);
            return false;
        }
