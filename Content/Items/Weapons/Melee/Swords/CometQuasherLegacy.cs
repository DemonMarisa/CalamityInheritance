...
{
    public class CometQuasherLegacy : CIMelee
    {
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                int proj = Projectile.NewProjectile(player.GetSource_ItemUse(Item), position, velocity, ProjectileType<CQuasherMeteor>(), meteorDamage, meteorKnockback, player.whoAmI, 0f, 0.5f + Main.rand.NextFloat() * 0.3f, target.Center.Y);
        ...
        public override void AddRecipes()
        {
            if (CIUtils.HasCalamity())
            {
                CreateRecipe().
                    ...
                    AddIngredient(CalamityMaterials.EssenceofSunlight, 4).
                    AddIngredient(CalamityMaterials.StarblightSoot, 12).
