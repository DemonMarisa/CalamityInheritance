...
{
    public class EarthLegacy : GeneralWeaponClass
    {
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Projectile.NewProjectile(source, realPlayerPos.X, realPlayerPos.Y, speedX4, speedY5, ModContent.ProjectileType<EarthProjLegacy>(), projDamage, hit.Knockback, player.whoAmI, 0f, (float)Main.rand.Next(10));
            }
        ...
        public override void OnHitPvp(Player player, Player target, Player.HurtInfo hurtInfo)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Projectile.NewProjectile(source, realPlayerPos.X, realPlayerPos.Y, speedX4, speedY5, ModContent.ProjectileType<EarthProjLegacy>(), earthDamage, Item.knockBack, player.whoAmI, 0f, (float)Main.rand.Next(10));
            }
