...
{
    public class Disseminator : CIRanged
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int j = 0; j < targetArrayIndex; j++)
            {
                ...
                Projectile proj = Projectile.NewProjectileDirect(source, targetPosition, extraBulletVel, type, extraBulletDamage, knockback, player.whoAmI);
                ...
                proj = Projectile.NewProjectileDirect(source, targetPosition, extraBulletVel, type, extraBulletDamage, knockback, player.whoAmI);
                proj.extraUpdates += 14;
                proj.tileCollide = false;
                proj.timeLeft /= 2;
            }
        ...
        {
            CreateRecipe().
                AddIngredient<ConclaveCrossfire>().
