...
{
    public class HellbornLegacy : GeneralWeaponClass
    {
        ...
        public override float UseTimeMultiplier(Player player) => 1f - 0.5f * (player.CIMod().hellbornBoost * (1f / 600f));

        public override void ModifyWeaponDamage(Player player, ref StatModifier damage) => damage *= 1f + player.CIMod().hellbornBoost * (1f / 600f);

        public override void ModifyWeaponKnockback(Player player, ref StatModifier knockback) => knockback *= 1f + (player.CIMod().hellbornBoost * (1f / 600f));
        ...
        {
            player.CIMod().hellbornBoost = 600;
