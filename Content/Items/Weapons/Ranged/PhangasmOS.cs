...
namespace CalamityInheritance.Content.Items.Weapons.Ranged
{
    public class PhangasmOS : ModItem, ILocalizedModType
    {
        ...
        {
            Item.DrawItemGlowmaskSingleFrame(spriteBatch, rotation, ModContent.Request<Texture2D>("CalamityInheritance/Content/Items/Weapons/Ranged/PhangasmOSGlow").Value);
        }
