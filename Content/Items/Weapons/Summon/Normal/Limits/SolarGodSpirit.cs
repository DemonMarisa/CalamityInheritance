...
{
    public class SolarGodSpirit : CISummon
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ProjectileType<SolarGodSpiritMinionLegacy>();
        }
        public override bool CanUseItem(Player player) => !player.HasProj<SolarGodSpiritMinionLegacy>();
