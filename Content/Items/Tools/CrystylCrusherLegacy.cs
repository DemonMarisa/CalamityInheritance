...
using CalamityInheritance.Content.Projectiles.Tools;
...
{
    public class CrystylCrusherLegacy : CITools
    {
        ...
        {
            if (player.LAP().MouseRight && CanUseItem(player) && player.whoAmI == Main.myPlayer && !Main.mapFullscreen && !Main.blockMouse)
            {
