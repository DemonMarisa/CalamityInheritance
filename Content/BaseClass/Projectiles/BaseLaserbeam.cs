...
{
    public abstract class BaseLaserbeam : ModProjectile
    {
        ...
        {
            return CIUtils.PreciseDistanceToTileCollisionHit(Projectile.Center, Projectile.velocity.ToRotation(), MaxLaserLength);
        }
